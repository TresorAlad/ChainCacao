      ...
      <div className="w-full py-6 sm:py-8">
        ...
        <div className="bg-white rounded-[2rem] p-8 shadow-sm border border-[var(--color-border)] mb-10">
          ...
          {lotsLoading ? (
            ...
            <p className="text-sm text-gray-400 text-center py-6">Aucun lot reçu pour le moment. Les lots transférés vers vous apparaîtront ici.</p>
          ) : (
