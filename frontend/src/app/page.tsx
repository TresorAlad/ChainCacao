          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className={`transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 mb-10">
                <Link href="/login" className="btn btn-primary btn-lg w-full sm:w-auto group relative overflow-hidden">
                ...
                <Link href="#features" className="btn btn-secondary-outline w-full sm:w-auto group">
            ...
            <div className={`relative transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              <div className="relative w-full max-w-lg mx-auto">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center gap-4 p-4 rounded-xl bg-[var(--color-bg)]/50 border border-[var(--color-border)]/50">
                        <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[var(--color-primary)]/20 to-[var(--color-secondary)]/20 flex items-center justify-center">
                          <PackageIcon className="w-6 h-6 text-[var(--color-primary)]" />
                        </div>
                        <div>
                          <p className="text-sm text-[var(--color-muted)]">Cacao Forastero</p>
                          <p className="font-semibold text-[var(--color-earth)]">Variété Nacional</p>
                        </div>
                      </div>
                ...
                <div className="absolute top-1/2 -right-6 w-12 h-12 rounded-lg bg-gradient-to-br from-[var(--color-secondary)]/30 to-[var(--color-secondary)]/10 border border-[var(--color-secondary)]/30 backdrop-blur-sm flex items-center justify-center animate-bounce" style={{ animationDelay: '1s' }}>
                  <TrendingUpIcon className="w-4 h-4 text-[var(--color-secondary)]" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid-cols-responsive grid gap-8">
            {features.map((feature, index) => (
              <div
                key={index}
                className="card p-8 group hover:shadow-xl transition-all duration-500 cursor-pointer"
                style={{ 
              ...
              >
                <div className={`stat-card-icon ${feature.color} ${feature.iconColor} mb-6 w-14 h-14 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-all duration-500 shadow-lg`}>
                ...
                <div className="pt-4 border-t border-[var(--color-border)]">
                  <Link 
                    href={`/${feature.title.toLowerCase().replace(/ /g, '-').replace(/\//g, '-')}`}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid-cols-stats grid gap-8">
            {stats.map((stat, index) => (
              <div
                key={index}
                className="stat-card text-center p-8 group hover:scale-105 transition-all duration-500 cursor-pointer"
                style={{
                  animationDelay: `${index * 0.1}s`,
                  opacity: isVisible ? 1 : 0,
                  transform: isVisible ? 'translateY(0)' : 'translateY(30px)'
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/register" className="btn btn-accent btn-lg w-full sm:w-auto group relative overflow-hidden">
              <span className="relative z-10 flex items-center gap-2">
            ...
            <Link href="/login" className="btn btn-accent-outline w-full sm:w-auto group">
              <span className="flex items-center gap-2">
                Se Connecter
                <svg className="w-4 h-4 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
